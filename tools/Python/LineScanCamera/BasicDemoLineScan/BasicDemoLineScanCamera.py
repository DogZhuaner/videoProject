...
if __name__ == "__main__":
    ...
    for i in range(0, deviceList.nDeviceNum):
        ...
        if mvcc_dev_info.nTLayerType == MV_GIGE_DEVICE or mvcc_dev_info.nTLayerType == MV_GENTL_GIGE_DEVICE:
            ...
            byte_str = bytes(memoryview(mvcc_dev_info.SpecialInfo.stGigEInfo.chUserDefinedName)).split(b'\x00')[0]
            strUserDefinedName = byte_str.decode('gbk')  #  关键步骤！使用正确的编码
            ...
            byte_str = bytes(memoryview(mvcc_dev_info.SpecialInfo.stUsb3VInfo.chUserDefinedName)).split(b'\x00')[0]
            strUserDefinedName = byte_str.decode('gbk')  #  关键步骤！使用正确的编码
            print("device user define name: %s" %strUserDefinedName)
            ...
            byte_str = bytes(memoryview(mvcc_dev_info.SpecialInfo.stXoFInfo.chUserDefinedName)).split(b'\x00')[0]
            strUserDefinedName = byte_str.decode('gbk')  #  关键步骤！使用正确的编码
            print("device user define name: %s" %strUserDefinedName)
            ...
            byte_str = bytes(memoryview(mvcc_dev_info.SpecialInfo.stCXPInfo.chUserDefinedName)).split(b'\x00')[0]
            strUserDefinedName = byte_str.decode('gbk')  #  关键步骤！使用正确的编码
            print("device user define name: %s" %strUserDefinedName)
            ...
            byte_str = bytes(memoryview(mvcc_dev_info.SpecialInfo.stCMLInfo.chUserDefinedName)).split(b'\x00')[0]
            strUserDefinedName = byte_str.decode('gbk')  #  关键步骤！使用正确的编码
            print("device user define name: %s" %strUserDefinedName)
